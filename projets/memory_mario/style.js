const cardsArray = [{name: 'Mario', img: 'Mario.jpg'},
                    {name: 'Dragon', img: 'Dragon.jpg'},
                    {name: 'Green', img: 'Greeen.jpg'},
                    {name: 'Pink', img: 'Pink.jpg'},
                    {name: 'Princess', img: 'Princess.jpg'},
                    {name: 'Tode', img: 'Tode.jpg'},
                    {name: 'Mario', img: 'Mario.jpg'},
                    {name: 'Dragon', img: 'Dragon.jpg'},
                    {name: 'Green', img: 'Greeen.jpg'},
                    {name: 'Pink', img: 'Pink.jpg'},
                    {name: 'Princess', img: 'Princess.jpg'},
...
const backImg ='box.jfif'
const winImg = 'coin.jfif'
...
function checkCards(){
    ...
    if(cardChosenFirst.getAttribute('src') === cardChosenSecond.getAttribute('src') && cardsChosenId[0] != cardsChosenId[1]){
        alert('Congratulations! U have a pair!')
